...
Nossa implementação encontra-se no seguinte repositório no github: https://github.com/gutoboranga/tower-defense

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{PARADIGMA} \label{intro}

Para a primeira etapa optamos por implementar o jogo usando Orientação a Objetos devido a conhecimento prévio de ambos integrantes do grupo.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{REQUISITOS} \label{intro}

A seguir está a lista de requisitos para o paradigma de Orientação a Objetos. Para cada um, há um exemplo retirado do nosso código-fonte.
