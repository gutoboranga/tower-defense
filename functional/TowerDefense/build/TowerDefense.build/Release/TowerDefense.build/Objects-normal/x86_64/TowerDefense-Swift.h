...
SWIFT_MODULE_NAMESPACE_PUSH("TowerDefense")

SWIFT_CLASS("_TtC12TowerDefense11AppDelegate")
...
SWIFT_CLASS("_TtC12TowerDefense5Enemy")
@interface Enemy : StandardBlock
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12TowerDefense14AstronautEnemy")
@interface AstronautEnemy : Enemy
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12TowerDefense8EndScene")
...
SWIFT_CLASS("_TtC12TowerDefense9GameScene")
...
SWIFT_CLASS("_TtC12TowerDefense8HudLayer")
@interface HudLayer : SKSpriteNode
- (nonnull instancetype)initWithTexture:(SKTexture * _Nullable)texture color:(NSColor * _Nonnull)color size:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
- (void)mouseDown:(NSEvent * _Nonnull)event;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12TowerDefense9MenuScene")
...
SWIFT_CLASS("_TtC12TowerDefense10RoverEnemy")
@interface RoverEnemy : Enemy
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC12TowerDefense15SceneController")
@interface SceneController : NSViewController
